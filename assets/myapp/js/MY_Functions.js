...
function GuardarUsuario(){
    ...
    if(nombre != "" && apaterno != "" && amaterno != "" && telefono != "" && email != "" && username != "" && password != "" && ocupacion != ""){
        $.ajax({
            url:myBase_url+"index.php/Dashboard/SaveUser",
            type:'POST',
            data:{nombre:nombre,apaterno:apaterno,amaterno:amaterno,telefono:telefono,email:email,username:username,password:password,ocupacion:ocupacion},
            async: true,
            success:function(datos){
                swal({
                    title: "Exito",
